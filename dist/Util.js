...
class Util {
    static rleDecode(input) {
        let last = '', news = '', splited = input.toString('binary');
...
Util.PHOTOSIZE_SOURCE_LEGACY = 0;
Util.PHOTOSIZE_SOURCE_THUMBNAIL = 1;
Util.PHOTOSIZE_SOURCE_DIALOGPHOTO_SMALL = 2;
Util.PHOTOSIZE_SOURCE_DIALOGPHOTO_BIG = 3;
Util.PHOTOSIZE_SOURCE_STICKERSET_THUMBNAIL = 4;
Util.UNIQUE_WEB = 0;
Util.UNIQUE_PHOTO = 1;
Util.UNIQUE_DOCUMENT = 2;
Util.UNIQUE_SECURE = 3;
Util.UNIQUE_ENCRYPTED = 4;
Util.UNIQUE_TEMP = 5;
Util.TYPES = [
    'thumbnail',
    'profile_photo',
